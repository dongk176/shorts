    ...
    def _select_with_gemini(
        ...
        *,
        ...
        system = (
            ...
            "[후킹 제목]\n"
            "1. 형식: 반드시 딱 2행으로 작성할 것.\n"
            "2. 글자 수: 1행은 공백 포함 5~18자, 2행도 공백 포함 5~18자를 엄격하게 "
            "지킬 것.\n"
            "3. 톤앤매너: 군더더기 없이 직관적이고, 굵고 강렬한 임팩트를 주는 말투를 "
            "사용할 것.\n"
            "4. 후킹 포인트:\n"
            "- 시청자의 깊은 공감을 유발하거나\n"
            "- 호기심을 극대화하여 결말을 궁금하게 만들거나\n"
            "- 대본의 핵심적인 반전이나 갈등 요소를 전면에 내세울 것.\n"
            f"- 자연스러운 {language_name}로 작성할 것.\n"
