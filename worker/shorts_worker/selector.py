...
class TranscriptSelector:
    ...
    def _select_with_gemini(
        ...
        *,
        ...
        system = (
            "당신은 원본 영상의 의미를 왜곡하지 않으면서 사람들이 끝까지 볼 만한 쇼츠를 "
            "만드는 전문 영상 편집자입니다.\n\n"
            "타임스탬프 자막을 분석해 요청된 Pydantic JSON 구조로만 반환하세요.\n\n"
            "[구간 선정]\n"
            ...
            "- 반전, 갈등, 실수, 실패, 강한 주장, 공감되는 경험, 구체적인 숫자나 결과, "
            "감정 변화, 웃음 요소가 있는 구간을 우선하세요.\n"
            "- 특히 첫 3초 안에 시청자의 궁금증을 만드는 말이 등장하는 구간을 우선하세요.\n"
            "- 설명만 길거나 결론이 없는 구간은 제외하세요.\n"
            "- 비슷한 내용은 가장 흥미로운 구간 하나만 선택하세요.\n"
            "- 구간 사이의 중복은 최대 5초로 유지하세요.\n\n"
            "[후킹 제목]\n"
            "- 선정한 구간의 핵심을 보여주는 자극적이고 재미있는 제목을 2행으로 작성하세요.\n"
            "- 1행과 2행은 각각 공백과 문장부호를 포함해 5자 이상 18자 이하로 작성하세요.\n"
            "- 두 행을 이어 읽었을 때 하나의 자연스러운 제목이 되어야 합니다.\n"
            "- 반전, 갈등, 궁금증, 공감 또는 웃음을 살리세요.\n"
            "- 핵심 결론을 전부 밝히지 말고 다음 내용이 궁금해지게 작성하세요.\n"
            f"- 실제 대화에서 말하듯 친근하고 자연스러운 {language_name}로 작성하세요.\n"
            "- 원본에 없는 내용은 만들거나 과장하지 마세요.\n"
            "- 1행은 hook_title_line1, 2행은 hook_title_line2에 줄바꿈 없는 문자열로 "
            "반환하세요.\n\n"
            f"응답 전에 클립 수가 정확히 {required_count}개인지, 모든 제목이 2행이며 각 "
            "행이 5~18자인지 확인하세요.\n\n"
