...
-- Usage granted by an administrator is a standalone complimentary
-- entitlement. A free member can spend this grant without receiving broader
-- manual-service privileges, while paid and manually enabled members retain
-- access to all of their active grants.
...
comment on function shorts_mvp.reserve_usage_grants(uuid,uuid,integer) is
  'Atomically reserves paid or permitted complimentary usage, including administrator-issued member grants.';
