-- The curated public example set is exactly projects 98 and 120.
-- Keep this after every historical example migration so a full replay
-- restores the intended pair without republishing retired examples.
...
where (id, project_number, video_title) in (
  ...
  (
    'ed706a47-1238-4243-9984-a361ca9595cf'::uuid,
    120,
    '뉴저지 갱스터 시절 기억이 떠올랐습니다. [GTA5]'
  )
);
