...
export function projectDispatchTarget(sourceRangeSelectionEnabled: boolean): ProjectDispatchTarget {
  ...
  return {
    jobDefinitionArn: requiredArn("LEGACY_PROJECT_JOB_DEFINITION_ARN", JOB_DEFINITION_ARN),
    jobQueueArn: requiredArn("LEGACY_PROJECT_BATCH_QUEUE_ARN", JOB_QUEUE_ARN),
  };
}
