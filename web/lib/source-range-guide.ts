...
export const sourceRangeGuideSteps = [
  {
    ...
    eyebrow: "구간 선택 · 시작",
    title: "시작점을 정하세요",
    description: "왼쪽 손잡이를 움직여 분석을 시작할 지점을 정하세요. 아래 시작 시각에 직접 입력할 수도 있어요.",
    targetSelector: '[data-source-range-guide="start-handle"]',
  ...
  },
  {
    ...
    eyebrow: "구간 선택 · 종료",
    title: "끝점을 정하세요",
    description: "오른쪽 손잡이를 움직여 분석을 마칠 지점을 정하세요. 한 번에 최대 60분까지 선택할 수 있어요.",
    targetSelector: '[data-source-range-guide="end-handle"]',
    placement: "above" as const,
    scrollBlock: "center" as const,
  },
  {
