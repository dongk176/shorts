    ...
    >
      ...
      <LegalSection title="제2조 용어의 뜻">
        <ul>
          ...
          <li>• <strong className="text-white">경과 이용대금</strong>: 실 결제금액을 전체 계약일수로 나눈 뒤 서비스 개시일부터 중도 해지 효력 발생일까지의 경과일수를 곱해 산정한 금액입니다.</li>
          <li>• <strong className="text-white">잔여기간 이용대금</strong>: 실 결제금액에서 경과 이용대금을 뺀 금액입니다.</li>
          <li>• <strong className="text-white">중도해지 위약금</strong>: 이용자의 책임 있는 사유로 기간형 유료서비스를 즉시 중도해지할 때 잔여기간 이용대금의 10%로 산정하는 금액입니다.</li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="제3조 상품별 결제 및 제공 기준">
        <div className="overflow-x-auto">
          <table>
            ...
            <tbody>
              ...
              <tr><td>기간 패키지</td><td>3·6·12개월 동안 유료 기능에 접근하는 기간형 서비스이며 처리시간은 매월 부여</td><td>자동갱신하지 않으며 중도 해지 시 경과일수에 따라 정산</td></tr>
        ...
        <p>처리시간이 선불전자지급수단에 해당하지 않는다는 점은 이용자의 법정 청약철회, 계약 해제·해지, 과오금 반환 또는 관계 법령과 본 정책에 따른 환불 권리를 제한하지 않습니다.</p>
      </LegalSection>
      ...
      <LegalSection title="제6조 청약철회와 전액 환불">
        ...
        <p>실시간 인기 페이지의 기본 목록을 열거나 잠긴 필터를 누른 것만으로는 유료 기능을 사용한 것으로 보지 않습니다. 로그인한 유료 이용자가 필터를 적용하고 회사 서버가 결과를 정상 제공한 경우에만 유료 필터 사용으로 기록하며, 오류로 결과가 제공되지 않은 요청은 사용으로 기록하지 않습니다.</p>
      </LegalSection>

      <LegalSection title="제7조 사용 후 중도 해지 및 부분 환불">
        <p>유료서비스 제공이 시작된 뒤 이용자가 단순 변심, 이용 필요성 소멸, 다른 서비스 이용 또는 기술적으로 정상 제공된 결과에 대한 주관적인 불만 등 이용자의 책임 있는 사유로 기간형 유료서비스의 즉시 종료와 환불을 요청하면 아래 산식으로 환불액을 계산합니다.</p>
        <div className="rounded-2xl border border-white/10 bg-white/[.035] p-5 text-center sm:p-6">
          ...
          <p className="mt-2 text-base font-black leading-7 text-white sm:text-lg">잔여기간 이용대금 − 중도해지 위약금</p>
        </div>
        <ul>
          <li>• 경과 이용대금 = 실 결제금액 × 경과일수 ÷ 전체 계약일수</li>
          <li>• 잔여기간 이용대금 = 실 결제금액 − 경과 이용대금</li>
          <li>• 중도해지 위약금 = 잔여기간 이용대금 × 10%</li>
          <li>• 서비스에 접근할 수 있었던 기간은 실제 작업·처리시간 사용 여부와 관계없이 경과일수에 포함합니다. 따라서 사용량이 없었던 이미 경과한 월 또는 날짜도 경과 이용대금에 포함됩니다.</li>
      ...
      <LegalSection title="제8조 청약철회 또는 환불이 제한되는 경우">
        ...
        <ul>
          ...
          <li>• 활성 이용권 전용 실시간 인기 필터를 적용하여 필터 결과를 제공받은 경우</li>
          <li>• 생성 결과물이 정상적으로 제공되었으나 취향, 기대 조회수, 편집 선호, AI 결과의 주관적 만족도 등을 이유로 환불을 요청하는 경우</li>
          <li>• 서비스가 3분 이상 60분 이하의 롱폼 원본 영상만 지원한다는 사실을 결제 전에 고지했음에도 YouTube Shorts 등 3분 미만의 숏폼 원본을 입력한 경우</li>
      ...
      <LegalSection title="제12조 약관 위반과 회사의 계약 해지">
        ...
        <p>이용자의 귀책사유로 기간형 유료서비스가 종료되는 경우 제7조의 경과 이용대금과 중도해지 위약금, 미납금 및 법령상 별도로 인정되는 손해를 정산할 수 있습니다. 중대한 불법행위, 결제 사기 또는 권리침해에 대해서는 환불 여부와 별도로 손해배상을 청구할 수 있습니다.</p>
      </LegalSection>
      ...
      <LegalSection title="제15조 기록, 입증 및 부정 환불 방지">
        <p>회사는 결제, 사용량 예약·확정·반환, 작업 성공·실패, 유료 인기 필터 결과 제공, 다운로드, 구독 변경 및 환불 처리 기록을 관련 법령과 <Link href="/privacy" className={accentLink}>개인정보처리방침</Link>이 정한 기간 동안 보관할 수 있습니다.</p>
