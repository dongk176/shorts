...
export const metadata: Metadata = createPageMetadata({
  title: "취소 및 환불 정책 v1 | Easy Cut",
  description: "결제 당시 환불정책 v1이 표시·기록된 거래에 적용되는 이전 취소 및 환불 정책입니다.",
  path: "/refund/versions/1",
});

const accentLink = "font-bold text-[#ff8c7c] underline underline-offset-4";

export default function RefundPolicyVersionOnePage() {
  return (
    <LegalDocument
    ...
    >
      <p className="rounded-2xl border border-amber-300/20 bg-amber-300/[.07] p-4 text-sm leading-6 text-amber-100">
        이 페이지는 결제 당시 환불정책 v1이 표시·기록된 거래에 적용되는 이전 정책입니다. 현재 정책은 <Link href="/refund" className={accentLink}>취소 및 환불 정책</Link>에서 확인할 수 있습니다.
      </p>
