  ...
  return (
    ...
    >
      <section aria-labelledby="purchase-summary" className="overflow-hidden rounded-3xl border border-[#ff8c7c]/25 bg-[linear-gradient(135deg,rgba(255,113,94,.12),rgba(160,120,255,.07))] p-5 sm:p-7">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-3">
          ...
          <div className="rounded-2xl border border-white/10 bg-black/15 p-4">
            ...
            <p className="mt-2 text-xs leading-6 text-neutral-400">월별 이용권 3·6·12개를 한 번 결제합니다. 사용한 월은 계약 월단가로 정산하고 미래 월은 환불합니다.</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-black/15 p-4">
      ...
      <LegalSection title="제5조 구독 갱신과 해지">
        ...
        <p>기간 패키지의 계약 월단가는 할인 전 월간 가격이 아니라 해당 주문의 실 결제금액을 계약 개월 수로 나눈 금액입니다. 환불정책 v2 주문은 이미 끝난 월과 현재 사용한 월의 계약 월단가를 공제하고, 현재 미사용 월과 아직 시작되지 않은 미래 월을 환불합니다.</p>
      ...
      <LegalSection title="제8조 청약철회·취소 및 환불">
        ...
        <p>환불정책 v2 기간 패키지에서 현재 월에 유료 작업, 기본 처리시간, 유료 필터 또는 유료 디지털콘텐츠를 사용했다면 현재 월 계약 월단가를 공제하고 그 월 종료일까지 권한을 유지합니다. 현재 월을 전혀 사용하지 않았다면 현재 월과 미래 월을 환불하고 권한을 종료할 수 있습니다. 별도 구매한 추가 처리시간만 사용한 작업은 패키지 사용 월로 중복 계산하지 않으며, 별도의 잔여기간 10% 위약금은 공제하지 않습니다.</p>
