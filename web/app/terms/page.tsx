...
export default function TermsPage() {
  return (
    <LegalDocument eyebrow="Terms of Service" title="서비스 이용약관" description="본 약관은 Easy Cut이 제공하는 YouTube 영상 기반 쇼츠 제작 서비스의 이용 조건과 운영팀 및 이용자의 권리·의무를 정합니다." effectiveDate="2026년 7월 26일" translations={termsTranslations}>
      ...
      <LegalSection title="제3조 서비스 이용 조건">
        <ul><li>• 서비스는 3분 이상의 긴 원본 영상에서 쇼츠 후보를 만드는 용도로 제공됩니다. 4분 이상 영상은 한 작업에서 4분 이상 60분 이하의 구간을 직접 선택하며, 3분 이상 4분 미만 영상은 전체를 처리합니다.</li><li>• YouTube Shorts 등 3분 미만의 숏폼 영상을 다시 쇼츠로 만드는 기능은 지원하지 않습니다.</li><li>• 기본적으로 한 번에 하나의 생성 작업만 진행할 수 있습니다.</li><li>• 생성 개수, 보관 기간, 이용량 및 기능 범위는 선택한 요금제에 따라 달라질 수 있습니다.</li><li>• 외부 플랫폼의 정책, 원본 상태, 네트워크 또는 AI 처리 결과에 따라 생성이 제한되거나 실패할 수 있습니다.</li></ul>
      </LegalSection>
      ...
      <LegalSection title="제6조 AI 처리 및 생성 결과">
        <p>서비스는 OpenAI API로 작업 영상의 오디오를 전사하고, 유료 Google Gemini API 또는 OpenAI API로 전사문과 영상·클립 정보를 분석하여 하이라이트, 제목 및 댓글 캡처 템플릿의 합성 댓글 문구를 생성합니다. 구체적인 전송 항목, 국가, 보유기간과 거부 방법은 <Link href="/privacy#international-transfers" className="font-bold text-[#ff8c7c] underline underline-offset-4">개인정보처리방침의 국외이전 항목</Link>을 따릅니다.</p>
        <p>AI가 만든 하이라이트, 제목, 자막 및 합성 댓글에는 오류·누락·부정확하거나 부적절한 내용이 포함될 수 있으며 합성 댓글은 실제 이용자의 반응이 아닙니다. AI 결과는 이용자에게 법적 또는 그와 유사한 중대한 효과를 주는 자동화된 결정이 아니라 편집 보조 자료입니다. 이용자는 결과물을 게시하거나 상업적으로 이용하기 전에 적법성, 정확성, 표시의 오인 가능성 및 권리 관계를 직접 검토해야 합니다.</p>
      </LegalSection>
      <LegalSection title="제7조 요금제와 결제">
        <p>유료 기능이 제공되는 경우 가격, 제공량, 결제 주기 및 환불 조건은 결제 전에 별도로 표시됩니다. 구매·갱신·플랜 변경과 추가 처리시간의 결제 조건은 <Link href="/purchase-terms" className="font-bold text-[#ff8c7c] underline underline-offset-4">유료서비스 구매약관</Link>을, 구독 해지·청약철회 및 환불의 세부 기준은 <Link href="/refund" className="font-bold text-[#ff8c7c] underline underline-offset-4">취소 및 환불 정책</Link>을 따릅니다. 외부 결제사업자의 정책이나 관련 법령에 따라 추가 조건이 적용될 수 있습니다. 무료 또는 시험 기능은 사전 안내 후 변경되거나 종료될 수 있습니다.</p>
        ...
        <p>처리시간이 선불전자지급수단에 해당하지 않는다는 점은 이용자의 법정 청약철회, 계약 해제·해지, 과오금 반환 또는 관계 법령과 취소 및 환불 정책에 따른 환불 권리를 제한하지 않습니다.</p>
      </LegalSection>
      <LegalSection title="제8조 보관 및 삭제">
        <p>선택한 원본 구간은 작업 중 임시 저장되며 작업 종료 시 삭제합니다. 편집용 클립, 완성 영상, 썸네일 및 자막은 요금제 정책에 따라 최초 생성일부터 최대 30일 보관되며 재편집하더라도 보관 기간이 연장되지 않을 수 있습니다.</p>
      ...
      <LegalSection title="제14조 약관의 변경 및 문의">
        ...
        <p>문의: 아티룸 고객센터 · 평일 14:00 ~ 19:00 · <a href="tel:010-4836-2874" className="text-[#ff8c7c] underline underline-offset-4">010-4836-2874</a> · <a href="mailto:easycut@easycut.co.kr" className="text-[#ff8c7c] underline underline-offset-4">easycut@easycut.co.kr</a></p>
      </LegalSection>
