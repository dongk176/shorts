  ...
  return (
    <LegalDocument eyebrow="Terms of Service" title="서비스 이용약관" description="본 약관은 Easy Cut이 제공하는 YouTube 영상 기반 쇼츠 제작 서비스의 이용 조건과 운영팀 및 이용자의 권리·의무를 정합니다." effectiveDate="2026년 7월 26일" translations={termsTranslations}>
      ...
      <LegalSection title="제3조 서비스 이용 조건">
        <ul><li>• 서비스는 긴 원본 영상에서 쇼츠 후보를 만드는 용도로 제공되며, 입력할 수 있는 원본 영상 길이는 3분 이상 60분 이하입니다.</li><li>• YouTube Shorts 등 3분 미만의 숏폼 영상을 다시 쇼츠로 만드는 기능은 지원하지 않습니다.</li><li>• 기본적으로 한 번에 하나의 생성 작업만 진행할 수 있습니다.</li><li>• 생성 개수, 보관 기간, 이용량 및 기능 범위는 선택한 요금제에 따라 달라질 수 있습니다.</li><li>• 외부 플랫폼의 정책, 원본 상태, 네트워크 또는 AI 처리 결과에 따라 생성이 제한되거나 실패할 수 있습니다.</li></ul>
      </LegalSection>
