...
export default function TermsPage() {
  return (
    <LegalDocument eyebrow="Terms of Service" title="서비스 이용약관" description="본 약관은 Easy Cut이 제공하는 YouTube 영상 기반 쇼츠 제작 서비스의 이용 조건과 운영팀 및 이용자의 권리·의무를 정합니다." effectiveDate="2026년 7월 14일">
      ...
      <LegalSection title="제7조 요금제와 결제"><p>유료 기능이 제공되는 경우 가격, 제공량, 결제 주기 및 환불 조건은 결제 전에 별도로 표시됩니다. 외부 결제사업자의 정책이나 관련 법령에 따라 추가 조건이 적용될 수 있습니다. 무료 또는 시험 기능은 사전 안내 후 변경되거나 종료될 수 있습니다.</p></LegalSection>
