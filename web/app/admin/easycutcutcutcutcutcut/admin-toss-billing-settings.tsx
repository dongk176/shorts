...
const controls: Array<{
  ...
  {
    flag: TOSS_RUNTIME_HANA_CARD_FLAG,
    key: "hanaCard",
    title: "하나카드 결제 허용",
    description: "심사 승인 전에는 하나카드의 카드등록과 모든 승인을 서버에서 차단합니다. 승인 후 이 스위치 하나로 즉시 허용할 수 있습니다.",
  },
];
    ...
    <section className="mt-7 rounded-2xl border border-white/10 bg-[#151819] p-5 sm:p-7">
      <div>
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-neutral-400">
          배포 없이 즉시 적용됩니다. 신규 배정·승인·자동갱신은 배포 설정과 운영 스위치가 모두 ON일 때만 동작하며, 하나카드는 별도 심사 스위치로 제어합니다.
        </p>
      </div>
