...
export const refundTranslationsV3: { en: LegalTranslation; ja: LegalTranslation } = {
  en: {
    ...
    sections: [
      ...
      { title: "8. Request and processing", paragraphs: ["Send the account email, order number, payment date and amount, product, and reason to artiroom176@gmail.com. Subscription cancellation, account deletion, or a general inquiry is not a completed refund request.", "We may request material needed to verify identity, payment, supply, and use. An approved refund is returned to the original payment method under the time and method required by law, and the related paid access, allowance, downloads, and benefits are removed."] },
      ...
      { title: "11. Business and contact", paragraphs: ["Business: Artiroom · Representative: Kim Dong-min · Business registration no. 638-04-03590 · Mail-order business report no. 2025-Seoul Mapo-2971 · Address: 40, Seongsan-ro 8-gil, Mapo-gu, Seoul, Republic of Korea · Contact: artiroom176@gmail.com / +82-10-4836-2874"] },
    ],
  },
  ja: {
    eyebrow: "Cancellation & Refund Policy",
    ...
    sections: [
      ...
      { title: "第8条 申請および処理", paragraphs: ["アカウントメール、注文番号、決済日・金額、商品名および申請理由をartiroom176@gmail.comへ送信してください。サブスクリプション解約、アカウント削除または一般問い合わせのみでは返金申請は完了しません。", "本人、決済、提供および利用を確認する資料を求める場合があります。承認された返金は法令上の期限・方法に従い元の決済手段へ処理し、関連する有料権限、利用量、ダウンロードおよび特典を回収します。"] },
      ...
      { title: "第11条 事業者・窓口", paragraphs: ["商号：Artiroom · 代表者：Kim Dong-min · 事業者登録番号：638-04-03590 · 通信販売業届出番号：2025-Seoul Mapo-2971 · 住所：40, Seongsan-ro 8-gil, Mapo-gu, Seoul, Republic of Korea · 問い合わせ：artiroom176@gmail.com / +82-10-4836-2874"] },
    ],
  },
};
